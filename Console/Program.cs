...
namespace LargeFileSplitter
{
    ...
    {
        private const int DefaultNumFilesToCreate = 2;
        private const string HelpArg = "/?";
        private static char[] FilePathDelimiters = new[] { '"' };

        private static void Main(string[] args)
        {
#if DEBUG
            string theFileCsvYouWantToSplit = $@"{Environment.CurrentDirectory}\Samples\customers-100000.csv";
            string theNumberOfFilesSplitted = "10";
            args = new string[] { theFileCsvYouWantToSplit, theNumberOfFilesSplitted };
#endif
            HandleHelp(args);
        ...
        /// <summary>
        /// Take a user's argument that's supposed to be an integer.
        /// If it parses as an int, return it as an int.
        /// If not, use the application's default.
        /// If it's a decimal, that'll use the app default.
        /// </summary>
        ...
        private static int NumberOrAppDefault(string input)
        {
            int num;
        ...
        /// Ensure all args are valid to continue.
        /// If any args are invalid, then show a message to the user and cause the app to exit.
        /// </summary>
        ...
        private static SplitJob BuildSplitJob(string[] args)
        {
        ...
        /// <summary>
        /// If the file to split is missing, prompt the user.
        /// Clean the arg of delimiters.
        ...
        /// <summary>
        /// Detect whether the 'help' param was supplied.
        /// Detects for /? being the first argument.
        /// If found, show the help text for the user.
        /// </summary>
